...
def Read_HFBTHO_Masstable(thoout,bl,Output_Dict, Incomp_No, Incomp_Other):
    ...
    for line in lines:
        ...
        try:
            ...
            #---------------------------------
            elif((ss[0] == "quadrupole") and ("moment" in ss[1])) and lipkin_nogami_flag:
              # This gathers LN deformation for final output, it works because no-LN moments are already
	      # read-in and quad_moment_Q2_T is not zero anymore.
            ...
            #-------------------------------
            elif((ss[0] == "octupole") and ("moment" in ss[1])) and lipkin_nogami_flag:
