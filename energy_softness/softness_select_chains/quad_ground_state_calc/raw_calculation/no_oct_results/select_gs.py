...
def select_gs(edf,cutoff=50):
    ...
    f_dir = "data/"
    f_name = edf +"_quad_gs_select_chains_all.dat"
    output_f1 = "sorted/" + edf + "_quad_gs_select_chains_sorted.dat"
...
def reduce_var(edf,cutoff=50):
    ...
    if len(edf) == 0 : edf = "SLY4"
    input_f1 = "sorted/"+edf+"_quad_gs_select_chains_sorted.dat"
    output_f2 = edf+"_quad_gs_select_chains_reduced.dat"
    outputFile = open("sorted/reduced/"+output_f2,"w")
    ...
    for line in l2:
        if i == 0:
            ...
            +"Q20_total".ljust(15)+"beta3_total".ljust(15)+"fileID".ljust(10)+"Convergence".ljust(15)+"\n"
        elif i > 0:
            ss = line.split()
