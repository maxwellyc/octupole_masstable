...
def select_gs(edf,cutoff=50):
    ...
    output_f1 = "gs_minima/" + edf + "_quad_gs_select_chains_sorted.dat"
...
def reduce_var(edf,cutoff=50):
    ...
    if len(edf) == 0 : edf = "SLY4"
    input_f1 = "gs_minima/"+edf+"_quad_gs_select_chains_sorted.dat"
    output_f2 = edf+"quad_gs_select_chains_reduced.dat"
    outputFile = open("gs_minima/reduced/"+output_f2,"w")
