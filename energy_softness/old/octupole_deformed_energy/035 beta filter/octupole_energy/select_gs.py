...
def select_gs():
    ...
    f_name = edf +"_octupole_softness_control.dat"
    output_f1 = "control_gs_extract/" + edf + "_control_groundstate_only.dat"
...
def reduce_var():
    edf = input("REDUCE::EDF(default SLY4 -OR- SKMS, SKP, SV-MIN, UNEDF0~2):") or "SLY4"
    input_f1 = "control_gs_extract/"+edf+"_control_groundstate_only.dat"
    output_f2 = edf+"_control_groundstate_reduced.dat"
