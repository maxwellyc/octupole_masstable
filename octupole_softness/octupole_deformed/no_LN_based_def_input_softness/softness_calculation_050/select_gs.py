...
def select_gs(edf,cutoff=40):
    ...
    f_dir = "raw/"
    f_name = edf +"_raw_softness_noLN.dat"
...
def reduce_var(edf,cutoff=40):
    ...
    if len(edf) == 0 : edf = "SLY4"
    input_f1 = "raw/"+edf+"_raw_softness_noLN.dat"
    output_f2 = edf+"_reduced_softness_noLN.dat"
...
for edf in ["UNEDF1","SV-MIN"]:#["SLY4","SKMS","SKP","SV-MIN","UNEDF0","UNEDF1","UNEDF2"]:
    reduce_var(edf,100)
